...
Last updated: 2026-09-26 (Stage 3: Rumeli legacy configuration plus all-branch 2%/5% thresholds and six waste reasons owner-approved and locally validated; remaining catalogue/other-branch configuration still INPUT REQUIRED; see docs/LOCAL_OPERATING_DATA_VALIDATION_2026-09-26.md).
