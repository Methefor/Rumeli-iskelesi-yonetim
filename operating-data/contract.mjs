...
export const COLUMNS = {
  ...
  /** Explicit removal of an obsolete branch/category mapping (omission alone cannot remove a seeded one). */
  category_branch_removals: ['branch_key', 'category_key', 'reason'],
...
export const KEY_FIELDS = {
  ...
  category_branch_removals: ['branch_key', 'category_key'],
