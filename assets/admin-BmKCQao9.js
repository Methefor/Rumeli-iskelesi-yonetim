import"./modulepreload-polyfill-B5Qt9EMX.js";import{supabase as _}from"./supabase-client-_4kS_E--.js";import"https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2/+esm";typeof window._adminLoadOk=="function"&&window._adminLoadOk();let y="month",S=null,F=null,z=null;function w(a){return a.getFullYear()+"-"+String(a.getMonth()+1).padStart(2,"0")+"-"+String(a.getDate()).padStart(2,"0")}async function U(){let a,t=null;const e=new Date;if(y==="day"&&z)a=z,t=z;else if(y==="custom"&&S&&F)a=S,t=F;else switch(y){case"week":const l=new Date;l.setDate(l.getDate()-7),a=w(l);break;case"month":a=w(new Date(e.getFullYear(),e.getMonth(),1)),t=w(new Date(e.getFullYear(),e.getMonth()+1,0));break;case"lastmonth":a=w(new Date(e.getFullYear(),e.getMonth()-1,1)),t=w(new Date(e.getFullYear(),e.getMonth(),0));break;case"all":a="2020-01-01";break;default:a=w(new Date(e.getFullYear(),e.getMonth(),1)),t=w(new Date(e.getFullYear(),e.getMonth()+1,0))}let s=_.from("daily_reports").select("*, cashiers(name)").gte("date",a).order("date",{ascending:!1});t&&(s=s.lte("date",t));const[i,o]=await Promise.all([s,_.from("cashiers").select("*").order("total_points",{ascending:!1})]);return{weekly:[],reports:i.data||[],cashiers:o.data||[]}}function Q(a){const t={},e={};let s=0,i=0,o=0;a.forEach(d=>{if(d.kasa==="ana_kasa"||d.kasa==="iki_kasa"){const u=`${d.date}-${d.kasa}`;(!t[u]||d.shift==="aksam")&&(t[u]=d)}else d.kasa==="tek_kasa"?(!e[d.date]||d.shift==="aksam")&&(e[d.date]=d):(s+=parseFloat(d.rumeli_z1||0)+parseFloat(d.rumeli_z2||0),i+=parseFloat(d.balik_ekmek||0),o+=parseFloat(d.dondurma||0))});const l=Object.values(t).reduce((d,u)=>(d.z+=parseFloat(u.rumeli_z1||0),d.balik+=parseFloat(u.balik_ekmek||0),d.dond+=parseFloat(u.dondurma||0),d),{z:0,balik:0,dond:0}),p=Object.values(e).reduce((d,u)=>(d.z+=parseFloat(u.rumeli_z1||0),d.balik+=parseFloat(u.balik_ekmek||0),d.dond+=parseFloat(u.dondurma||0),d),{z:0,balik:0,dond:0}),c=l.z+p.z+s,g=l.balik+p.balik+i,f=l.dond+p.dond+o;return{zRaporu:c,balik:g,dondurma:f,total:c+g+f,restoran:0,cafetarya:0}}function J(a,t){const e={};return t.forEach(s=>{e[s.id]={cashier_id:s.id,name:s.name,badge_level:s.badge_level,total_score:0,entry_count:0,on_time_count:0}}),a.forEach(s=>{var l;const i=s.cashier_id;if(!e[i]){const p=((l=s.cashiers)==null?void 0:l.name)||"Bilinmiyor";e[i]={cashier_id:i,name:p,badge_level:null,total_score:0,entry_count:0,on_time_count:0}}const o=(s.is_on_time?50:0)+(parseFloat(s.rumeli_z1||0)>0||parseFloat(s.total_revenue||0)>0?50:0);e[i].total_score+=o,e[i].entry_count+=1,s.is_on_time&&(e[i].on_time_count+=1)}),Object.values(e).map(s=>({...s,performance_pct:s.entry_count>=1?Math.round(s.total_score/(s.entry_count*100)*100):null})).sort((s,i)=>s.performance_pct===null&&i.performance_pct===null?0:s.performance_pct===null?1:i.performance_pct===null?-1:i.performance_pct!==s.performance_pct?i.performance_pct-s.performance_pct:i.entry_count-s.entry_count)}function G(a){const t={};a.forEach(i=>{const o=`${i.date}-${i.kasa||"x"}`;(!t[o]||i.shift==="aksam")&&(t[o]=i)});const e={};Object.values(t).forEach(i=>{e[i.date]||(e[i.date]=0),e[i.date]+=parseFloat(i.rumeli_z1||0)+parseFloat(i.rumeli_z2||0)+parseFloat(i.balik_ekmek||0)+parseFloat(i.dondurma||0)});const s=Object.keys(e).sort();return{labels:s.map(i=>H(i)),data:s.map(i=>e[i])}}function X(a){const t={sabah:0,aksam:0};return a.forEach(e=>{const s=parseFloat(e.individual_revenue||0);e.shift==="sabah"?t.sabah+=s:e.shift==="aksam"&&(t.aksam+=s)}),t}function tt(a,t){const e={};return a.forEach(s=>{var o;const i=((o=s.cashiers)==null?void 0:o.name)||"Bilinmiyor";e[i]||(e[i]=0),e[i]+=parseFloat(s.individual_revenue||0)}),e}function at(a,t){const e=w(new Date),s=a.filter(g=>g.date===e),i=[...new Set(s.map(g=>g.cashier_id))],o=t.filter(g=>!i.includes(g.id)),l=a.filter(g=>!g.is_on_time),p=G(a),c=Math.max(...p.data,0);return{notEntered:o,lateEntries:l,maxCiro:c}}function et(a){const t=G(a),e=Math.max(...t.data,0),s=w(new Date),i=a.filter(g=>g.date===s),l=[...new Set(i.map(g=>g.cashier_id))].length;return{maxDailyCiro:e,activeCashiers:l,avgEntryTime:"2.5dk",weeklyGrowth:"+12%"}}function it(){const a=new Date,t=a.getDay(),e=["2026-01-01","2026-04-23","2026-05-01","2026-05-19","2026-08-30","2026-10-29"],s=w(a);return e.includes(s)?"special":t===0||t===6?"weekend":"weekday"}async function st(){try{const a=it();console.log("Hedef tipi:",a);const{data:t,error:e}=await _.from("targets").select("amount").eq("target_type",a).single();return e?(console.error("Hedef çekme hatası:",e),{weekday:15e4,weekend:2e5,special:25e4}[a]):(console.log("Çekilen hedef:",t.amount),parseFloat(t.amount)||15e4)}catch(a){return console.error("fetchDailyTarget hatası:",a),15e4}}function ot(){typeof anime>"u"||(anime({targets:".kasa-card, .sc, .total-hero-card",opacity:[0,1],translateY:[40,0],delay:anime.stagger(100),duration:800,easing:"easeOutCubic"}),anime({targets:".rank-card",opacity:[0,1],translateX:[-40,0],delay:anime.stagger(120),duration:700,easing:"easeOutCubic"}))}function nt(){if(typeof anime>"u")return;const a=document.getElementById("totalDailyCiro"),t=parseFloat(a.getAttribute("data-value")||0);anime({targets:{value:0},value:t,duration:2e3,easing:"easeOutExpo",update:function(i){a.textContent=v(i.animations[0].currentValue)}});const e=document.getElementById("progressBarFill"),s=parseFloat(e.getAttribute("data-percent")||0);anime({targets:"#progressBarFill",width:s+"%",duration:1500,easing:"easeInOutQuad"})}function lt(a){const t={gida:{name:"Gıda",icon:"🥗",total:0,color:"#22c55e"},kahvalti:{name:"Kahvaltı",icon:"🥐",total:0,color:"#f59e0b"},kahve:{name:"Kahve",icon:"☕",total:0,color:"#8b5cf6"},meyvesuyu:{name:"Meyve Suyu",icon:"🧃",total:0,color:"#ec4899"},salata:{name:"Salata",icon:"🥙",total:0,color:"#06b6d4"},sicak_icecek:{name:"Sıcak İçecek",icon:"🔥",total:0,color:"#ef4444"},soguk_icecek:{name:"Soğuk İçecek",icon:"🥤",total:0,color:"#3b82f6"},tatli:{name:"Tatlı",icon:"🍰",total:0,color:"#a855f7"},dondurma_kategori:{name:"Dondurma",icon:"🍦",total:0,color:"#06b6d4"}},e={};a.forEach(o=>{const l=`${o.date}-${o.kasa}`;(!e[l]||o.shift==="aksam")&&(e[l]=o)}),Object.values(e).forEach(o=>{t.gida.total+=parseFloat(o.gida)||0,t.kahvalti.total+=parseFloat(o.kahvalti)||0,t.kahve.total+=parseFloat(o.kahve)||0,t.meyvesuyu.total+=parseFloat(o.meyvesuyu)||0,t.salata.total+=parseFloat(o.salata)||0,t.sicak_icecek.total+=parseFloat(o.sicak_icecek)||0,t.soguk_icecek.total+=parseFloat(o.soguk_icecek)||0,t.tatli.total+=parseFloat(o.tatli)||0,t.dondurma_kategori.total+=parseFloat(o.dondurma_kategori)||0});const s=Object.values(t).reduce((o,l)=>o+l.total,0);Object.values(t).forEach(o=>{o.percentage=s>0?o.total/s*100:0});const i=Object.entries(t).map(([o,l])=>({key:o,...l})).sort((o,l)=>l.total-o.total);return{categories:i,total:s,highest:i[0],lowest:i[i.length-1],average:s/i.length}}function rt(a){return a.categories.map(t=>`
                ...
                <div class="alert-card ${c.lateEntries.length>0?"warning":"ok"}">
                    ...
                    ${c.lateEntries.length===0?'<div class="alert-item">Bu hafta geç giriş yok! 🎉</div>':c.lateEntries.slice(0,5).map(m=>{var D;return`
                            <div class="alert-item">
                                ...
                                <span style="color:var(--orange)">${j(m.entry_time)}</span>
                            </div>
                        `}).join("")}
                </div>
            ...
            <div id="rankGrid" class="rank-grid">
                ${d.map((m,D)=>{const P=e.find(W=>W.id===m.cashier_id)||{},Y=P.id||"",q=V(P.badge_level),N=m.performance_pct!==null?m.performance_pct:"—",Z=m.performance_pct>=85?"var(--green)":m.performance_pct>=65?"var(--orange)":"var(--txt2)";return`
                    <div class="rank-card">
        ...
        `,ut(o,i,l,p);const x=document.getElementById("applyFiltersBtn"),M=document.getElementById("clearFiltersBtn");x&&x.addEventListener("click",vt),M&&M.addEventListener("click",pt),document.getElementById("lastUpdate").textContent="Son güncelleme: "+new Date().toLocaleTimeString("tr-TR",{timeZone:"Europe/Istanbul"}),setTimeout(()=>{ot(),nt(),gt()},100),yt(s,r,b)}let E={};function ut(a,t,e,s){Chart.defaults.color="#7a8ba8",Chart.defaults.borderColor="#1e3a5f",Chart.defaults.font.family="DM Sans";const i=document.getElementById("dailyChart");i&&(E.daily&&E.daily.destroy(),E.daily=new Chart(i,{type:"bar",data:{labels:a.labels.length>0?a.labels:["Veri Yok"],datasets:[{label:"Günlük Ciro (₺)",data:a.data.length>0?a.data:[0],backgroundColor:"rgba(59,130,246,.7)",borderColor:"#3b82f6",borderWidth:2,borderRadius:8}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:{grid:{color:"#1e3a5f"}},y:{grid:{color:"#1e3a5f"},ticks:{callback:c=>"₺"+new Intl.NumberFormat("tr-TR").format(c)}}}}}));const o=document.getElementById("kasaChart");if(o){E.kasa&&E.kasa.destroy();const c=t.total>0,g=c?[t.zRaporu,t.balik,t.dondurma]:[.001,.001,.001];E.kasa=new Chart(o,{type:"doughnut",data:{labels:["Rumeli İskelesi","Balık Ekmek","Dondurma"],datasets:[{data:g,backgroundColor:["rgba(59,130,246,.8)","rgba(6,182,212,.8)","rgba(236,72,153,.8)"],borderColor:"#111d32",borderWidth:3,hoverOffset:8}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"bottom",labels:{padding:16,usePointStyle:!0}},tooltip:{enabled:c,callbacks:{label:f=>{const d=f.raw,u=f.dataset.data.reduce((k,T)=>k+T,0),R=Math.round(d/u*100);return` ${f.label}: ${v(d)} (%${R})`}}}},cutout:"65%"}})}const l=document.getElementById("shiftChart");l&&(E.shift&&E.shift.destroy(),E.shift=new Chart(l,{type:"bar",data:{labels:["Sabah Vardiyası","Akşam Vardiyası"],datasets:[{label:"Ciro (₺)",data:[e.sabah||0,e.aksam||0],backgroundColor:["rgba(245,158,11,.7)","rgba(139,92,246,.7)"],borderColor:["#f59e0b","#8b5cf6"],borderWidth:2,borderRadius:8}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:{grid:{color:"#1e3a5f"}},y:{grid:{color:"#1e3a5f"},ticks:{callback:c=>"₺"+new Intl.NumberFormat("tr-TR").format(c)}}}}}));const p=document.getElementById("cashierChart");if(p){E.cashier&&E.cashier.destroy();const c=Object.keys(s),g=Object.values(s);E.cashier=new Chart(p,{type:"bar",data:{labels:c.length>0?c:["Veri Yok"],datasets:[{label:"Ciro (₺)",data:g.length>0?g:[0],backgroundColor:["rgba(139,92,246,.7)","rgba(245,158,11,.7)","rgba(236,72,153,.7)","rgba(34,197,94,.7)"],borderColor:["#8b5cf6","#f59e0b","#ec4899","#22c55e"],borderWidth:2,borderRadius:8}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:{grid:{color:"#1e3a5f"}},y:{grid:{color:"#1e3a5f"},ticks:{callback:f=>"₺"+new Intl.NumberFormat("tr-TR").format(f)}}}}})}}let K=[];function O(a){return a.length===0?'<tr><td colspan="9" style="text-align:center;color:var(--txt2);padding:40px;">Henüz veri yok</td></tr>':a.map(t=>{var i;const e=parseFloat(t.total_revenue||0),s=parseFloat(t.individual_revenue||e);return`
            ...
            `}).join("")}function vt(){const a=document.getElementById("filterDate").value,t=document.getElementById("filterKasiyer").value,e=document.getElementById("filterKasa").value,s=document.getElementById("filterVardiya").value;let i=[...K];a&&(i=i.filter(o=>o.date===a)),t&&(i=i.filter(o=>o.cashier_id===t)),e&&(i=i.filter(o=>o.kasa===e)),s&&(i=i.filter(o=>o.shift===s)),document.getElementById("entriesBody").innerHTML=O(i)}function pt(){document.getElementById("filterDate").value="",document.getElementById("filterKasiyer").value="",document.getElementById("filterKasa").value="",document.getElementById("filterVardiya").value="",document.getElementById("entriesBody").innerHTML=O(K)}function v(a){return new Intl.NumberFormat("tr-TR",{minimumFractionDigits:2,maximumFractionDigits:2}).format(a||0)+" ₺"}function L(a){return v(a)}function gt(){document.querySelectorAll(".kasa-amount[data-target]").forEach(a=>{const t=parseFloat(a.dataset.target)||0,e=1200,s=performance.now();function i(o){const l=Math.min((o-s)/e,1),p=1-Math.pow(1-l,3);a.textContent=v(t*p),l<1?requestAnimationFrame(i):a.textContent=v(t)}requestAnimationFrame(i)})}function yt(a,t,e){const s=document.getElementById("floatingTarget");if(!s)return;s.style.display="block",document.getElementById("ftPct").textContent=e+"%",document.getElementById("ftTarget").textContent=v(a),document.getElementById("ftCurrent").textContent=v(t);const i=[[100,"🎉 Hedef Tamamlandı!"],[80,"💪 Hedefe Yakın!"],[50,"⏰ Yarı Yolda!"],[0,"🚀 Devam Edelim!"]];document.getElementById("ftStatus").textContent=(i.find(([l])=>e>=l)||i[3])[1];const o=document.getElementById("ftBar");o.classList.toggle("done",e>=100),o.classList.toggle("near",e>=80&&e<100),setTimeout(()=>{o.style.width=Math.min(100,e)+"%"},200)}window.showVerimlilik=async function(){document.getElementById("verimlilikModal").style.display="flex";const a=document.getElementById("verimlilikBody");a.innerHTML='<div class="loading" style="padding:40px 0;"><div class="spinner"></div><div>Veriler hesaplanıyor...</div></div>';try{const t=new Date,e=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}-01`,s=new Date(t.getFullYear(),t.getMonth()+1,0).getDate(),i=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}-${s}`,{data:o}=await _.from("daily_reports").select("date, kasa, shift, rumeli_z1, rumeli_z2, balik_ekmek, dondurma").in("kasa",["restoran","cafetarya"]).gte("date",e).lte("date",i).order("date",{ascending:!0});if(!o||o.length===0){a.innerHTML='<div style="text-align:center;padding:40px;color:var(--txt2);">Bu ay için veri bulunamadı.</div>';return}const l={};o.forEach(n=>{const r=`${n.date}-${n.kasa}`;if(!l[r])l[r]=n;else{const b=l[r],$=n.kasa==="restoran"?parseFloat(n.rumeli_z2):parseFloat(n.rumeli_z1),x=b.kasa==="restoran"?parseFloat(b.rumeli_z2):parseFloat(b.rumeli_z1);(b.shift!=="aksam"&&n.shift==="aksam"||b.shift==="aksam"&&n.shift==="aksam"&&$>x)&&(l[r]=n)}});const p={};Object.values(l).forEach(n=>{p[n.date]||(p[n.date]={restoran:0,cafetarya:0,balik:0,dondurma:0}),n.kasa==="restoran"?p[n.date].restoran=parseFloat(n.rumeli_z2)||0:n.kasa==="cafetarya"&&(p[n.date].cafetarya=parseFloat(n.rumeli_z1)||0),p[n.date].balik+=parseFloat(n.balik_ekmek)||0,p[n.date].dondurma+=parseFloat(n.dondurma)||0});const c=Object.entries(p).map(([n,r])=>({date:n,total:(r.restoran||0)+(r.cafetarya||0),restoran:r.restoran||0,cafetarya:r.cafetarya||0,balik:r.balik||0,dondurma:r.dondurma||0})).sort((n,r)=>n.date.localeCompare(r.date)),g=c.reduce((n,r)=>n+r.total,0),f=c.length,d=f>0?g/f:0,u=c.reduce((n,r)=>r.total>n.total?r:n,c[0]),R=["Pazar","Pazartesi","Salı","Çarşamba","Perşembe","Cuma","Cumartesi"],k={},T={};c.forEach(n=>{const[r,b,$]=n.date.split("-").map(Number),x=new Date(r,b-1,$).getDay();k[x]=(k[x]||0)+n.total,T[x]=(T[x]||0)+1});const h=c.filter(n=>n.balik>0),I=[0,1,2,3,4,5,6].filter(n=>T[n]).map(n=>({name:R[n],avg:k[n]/T[n],idx:n})).sort((n,r)=>r.avg-n.avg),C=I.length>0?I[0].avg:1,B=t.toLocaleDateString("tr-TR",{month:"long",year:"numeric"});a.innerHTML=`
                    <div class="ver-stats-grid">
                        ...
                        <div class="ver-stat-card" style="border-color:var(--orange);">
                            ...
                            <div class="ver-stat-sub">${u?(()=>{const[n,r,b]=u.date.split("-").map(Number);return new Date(n,r-1,b).toLocaleDateString("tr-TR",{day:"numeric",month:"long",weekday:"short"})})():"-"}</div>
                        </div>
                    </div>
                    ...
                    <div style="display:flex;flex-direction:column;gap:8px;margin-bottom:24px;">
                        ${I.map((n,r)=>`
                            <div style="display:flex;align-items:center;gap:12px;">
                                ...
                                <div style="width:90px;font-size:13px;font-weight:600;">${n.name}</div>
                                <div style="flex:1;height:8px;background:rgba(255,255,255,.06);border-radius:4px;overflow:hidden;">
                                    <div style="height:100%;width:${Math.round(n.avg/C*100)}%;background:linear-gradient(90deg,${r===0?"#f59e0b,#f97316":"#3b82f6,#06b6d4"});border-radius:4px;transition:width 1s ease;"></div>
                                </div>
                                <div style="width:130px;text-align:right;font-family:'JetBrains Mono',monospace;font-size:12px;color:${r===0?"var(--orange)":"var(--txt)"};">${v(n.avg)}</div>
                            </div>
                        `).join("")}
                    </div>
                    ...
                    <div style="max-height:320px;overflow-y:auto;border-radius:10px;border:1px solid var(--brd);">
                        <table class="ver-daily-table">
                            ...
                            <tbody>
                                ${c.map(n=>{const r=n.date===(u==null?void 0:u.date),[b,$,x]=n.date.split("-").map(Number),M=new Date(b,$-1,x).toLocaleDateString("tr-TR",{weekday:"short"});return`<tr${r?' class="top-row"':""}>
                                        <td>${String(x).padStart(2,"0")+"/"+String($).padStart(2,"0")}</td>
                                        <td style="color:var(--txt2);font-family:sans-serif;font-size:12px;">${M}</td>
                                        <td>${v(n.restoran)}</td>
                                        <td>${v(n.cafetarya)}</td>
                                        <td style="font-weight:700;${r?"color:var(--orange);":""}">${v(n.total)}</td>
                                    </tr>`}).join("")}
                            </tbody>
                        </table>
                    </div>
                ...
                </div>`,document.body.appendChild(s)};window.selectBadgeOption=function(a,t){document.querySelectorAll(".badge-option").forEach(e=>e.classList.remove("selected")),a.classList.add("selected"),a.closest(".badge-modal-overlay").__selectedBadge=t};window.saveBadgeAssignment=async function(a){const t=document.querySelector(".badge-modal-overlay"),e=t==null?void 0:t.__selectedBadge;if(!e){alert("Lütfen bir rozet seçin.");return}try{let s=e;if(e==="auto"){const{data:o}=await _.from("cashiers").select("total_points").eq("id",a).single(),l=(o==null?void 0:o.total_points)||0;l>=600?s="efsane_plus":l>=400?s="efsane":l>=250?s="elmas":l>=150?s="altin":l>=75?s="gumus":l>=30?s="bronz":s="yeni"}const{error:i}=await _.from("cashiers").update({badge_level:s}).eq("id",a);if(i)throw i;t.remove(),A(`✅ Rozet atandı: ${V(s)}`,"success"),await loadDashboard()}catch(s){console.error("Rozet atama hatası:",s),alert("❌ Hata: "+s.message)}};window.toggleDetails=function(){const a=document.getElementById("detailedSection"),t=document.getElementById("toggleIcon"),e=document.getElementById("toggleText");a&&(a.style.display==="none"?(a.style.display="block",t.textContent="🙈",e.textContent="Detaylı Verileri Gizle"):(a.style.display="none",t.textContent="👁️",e.textContent="Detaylı Verileri Göster"))};window.setDateFilter=function(a){y=a,S=null,F=null,document.querySelectorAll(".filter-btn").forEach(c=>c.classList.remove("active"));const t=document.querySelector(`[data-range="${a}"]`);t&&t.classList.add("active");const e=new Date,s=e.toLocaleDateString("tr-TR",{month:"long",year:"numeric"}),o=new Date(e.getFullYear(),e.getMonth()-1,1).toLocaleDateString("tr-TR",{month:"long",year:"numeric"}),l={week:"Son 7 gün",month:`Bu Ay (${s})`,lastmonth:`Geçen Ay (${o})`,all:"Tüm veriler"},p=document.getElementById("filterInfo");p&&(p.textContent=l[a]||""),window.loadDashboard()};window.showDayPicker=function(){const a=document.createElement("div");a.className="custom-date-modal",a.style.display="flex",a.id="dayPickerModal",a.innerHTML=`
            ...
            `,document.body.appendChild(s)};window.confirmEdit=async function(a,t){const e=document.querySelector(".modal-overlay");try{const s=parseInt(document.getElementById("editPuan").value)||0,i=document.getElementById("editDurum").value==="true",o=document.getElementById("editZ1"),l=document.getElementById("editZ2"),p=document.getElementById("editBalik"),c=document.getElementById("editDondurma"),g=o?parseFloat(o.value)||0:null,f=l?parseFloat(l.value)||0:null,d=p?parseFloat(p.value)||0:null,u=c?parseFloat(c.value)||0:null,R=(g??0)+(f??0)+(d??0)+(u??0),k={points_earned:s,is_on_time:i,total_revenue:R};g!==null&&(k.rumeli_z1=g),f!==null&&(k.rumeli_z2=f),d!==null&&(k.balik_ekmek=d),u!==null&&(k.dondurma=u),console.log("Güncelleniyor:",{entryId:a,kasa:t,updatePayload:k});const{error:T}=await _.from("daily_reports").update(k).eq("id",a);if(T)throw T;const{data:h}=await _.from("daily_reports").select("cashier_id").eq("id",a).single();if(!h)throw new Error("Kayıt bulunamadı");const{data:I}=await _.from("daily_reports").select("points_earned").eq("cashier_id",h.cashier_id),C=I.reduce((r,b)=>r+(parseInt(b.points_earned)||0),0);console.log("Toplam puan:",C);let B="yeni";C>=1e3?B="efsane":C>=500?B="elmas":C>=300?B="altin":C>=150?B="gumus":C>=50&&(B="bronz");const{error:n}=await _.from("cashiers").update({total_points:C,badge_level:B}).eq("id",h.cashier_id);if(n)throw n;e&&e.remove(),A("✅ Kayıt ve kasiyer puanı güncellendi!","success"),await loadDashboard()}catch(s){console.error("Güncelleme hatası:",s),A("❌ Güncelleme başarısız: "+s.message,"error"),e&&e.remove()}};function A(a,t="success"){const e=document.createElement("div");e.style.cssText=`
                position:fixed;
                bottom:20px;
                right:20px;
