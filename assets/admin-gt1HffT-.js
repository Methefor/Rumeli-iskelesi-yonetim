import"./modulepreload-polyfill-B5Qt9EMX.js";import{supabase as $}from"./supabase-client-CFSZQWn8.js";import"https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2/+esm";let u="month",E=null,S=null,x=null;function R(a){return a.getFullYear()+"-"+String(a.getMonth()+1).padStart(2,"0")+"-"+String(a.getDate()).padStart(2,"0")}async function W(){let a,t=null;const e=new Date;if(u==="day"&&x)a=x,t=x;else if(u==="custom"&&E&&S)a=E,t=S;else switch(u){case"week":const l=new Date;l.setDate(l.getDate()-7),a=R(l);break;case"month":a=R(new Date(e.getFullYear(),e.getMonth(),1)),t=R(new Date(e.getFullYear(),e.getMonth()+1,0));break;case"lastmonth":a=R(new Date(e.getFullYear(),e.getMonth()-1,1)),t=R(new Date(e.getFullYear(),e.getMonth(),0));break;case"all":a="2020-01-01";break;default:a=R(new Date(e.getFullYear(),e.getMonth(),1)),t=R(new Date(e.getFullYear(),e.getMonth()+1,0))}let s=$.from("daily_reports").select("*, cashiers(name)").gte("date",a).order("date",{ascending:!1});t&&(s=s.lte("date",t));const[i,n]=await Promise.all([s,$.from("cashiers").select("*").order("total_points",{ascending:!1})]);return{weekly:[],reports:i.data||[],cashiers:n.data||[]}}function U(a){const t={};return a.forEach(e=>{const s=`${e.date}-${e.kasa}`;(!t[s]||e.shift==="aksam")&&(t[s]=e)}),Object.values(t).reduce((e,s)=>(e.restoran+=parseFloat(s.rumeli_z2||0),e.cafetarya+=parseFloat(s.rumeli_z1||0),e.balik+=parseFloat(s.balik_ekmek||0),e.dondurma+=parseFloat(s.dondurma||0),e.total+=parseFloat(s.rumeli_z2||0)+parseFloat(s.rumeli_z1||0)+parseFloat(s.balik_ekmek||0)+parseFloat(s.dondurma||0),e),{restoran:0,cafetarya:0,balik:0,dondurma:0,total:0})}function O(a){const t={};a.forEach(i=>{const n=`${i.date}-${i.kasa}`;(!t[n]||i.shift==="aksam")&&(t[n]=i)});const e={};Object.values(t).forEach(i=>{const n=i.date;e[n]||(e[n]=0),e[n]+=parseFloat(i.rumeli_z2||0)+parseFloat(i.rumeli_z1||0)+parseFloat(i.balik_ekmek||0)+parseFloat(i.dondurma||0)});const s=Object.keys(e).sort();return{labels:s.map(i=>V(i)),data:s.map(i=>e[i])}}function Q(a){const t={sabah:0,aksam:0};return a.forEach(e=>{const s=parseFloat(e.individual_revenue||0);e.shift==="sabah"?t.sabah+=s:e.shift==="aksam"&&(t.aksam+=s)}),t}function J(a,t){const e={};return a.forEach(s=>{var n;const i=((n=s.cashiers)==null?void 0:n.name)||"Bilinmiyor";e[i]||(e[i]=0),e[i]+=parseFloat(s.individual_revenue||0)}),e}function X(a,t){const e=new Date().toISOString().split("T")[0],s=a.filter(m=>m.date===e),i=[...new Set(s.map(m=>m.cashier_id))],n=t.filter(m=>!i.includes(m.id)),l=a.filter(m=>!m.is_on_time),y=O(a),d=Math.max(...y.data,0);return{notEntered:n,lateEntries:l,maxCiro:d}}function tt(a){const t=O(a),e=Math.max(...t.data,0),s=new Date().toISOString().split("T")[0],i=a.filter(m=>m.date===s),l=[...new Set(i.map(m=>m.cashier_id))].length;return{maxDailyCiro:e,activeCashiers:l,avgEntryTime:"2.5dk",weeklyGrowth:"+12%"}}function at(){const a=new Date,t=a.getDay(),e=["2026-01-01","2026-04-23","2026-05-01","2026-05-19","2026-08-30","2026-10-29"],s=a.toISOString().split("T")[0];return e.includes(s)?"special":t===0||t===6?"weekend":"weekday"}async function et(){try{const a=at();console.log("Hedef tipi:",a);const{data:t,error:e}=await $.from("targets").select("amount").eq("target_type",a).single();return e?(console.error("Hedef çekme hatası:",e),{weekday:15e4,weekend:2e5,special:25e4}[a]):(console.log("Çekilen hedef:",t.amount),parseFloat(t.amount)||15e4)}catch(a){return console.error("fetchDailyTarget hatası:",a),15e4}}function it(){typeof anime>"u"||(anime({targets:".kasa-card, .sc, .total-hero-card",opacity:[0,1],translateY:[40,0],delay:anime.stagger(100),duration:800,easing:"easeOutCubic"}),anime({targets:".rank-card",opacity:[0,1],translateX:[-40,0],delay:anime.stagger(120),duration:700,easing:"easeOutCubic"}))}function st(){if(typeof anime>"u")return;const a=document.getElementById("totalDailyCiro"),t=parseFloat(a.getAttribute("data-value")||0);anime({targets:{value:0},value:t,duration:2e3,easing:"easeOutExpo",update:function(i){a.textContent=v(i.animations[0].currentValue)}});const e=document.getElementById("progressBarFill"),s=parseFloat(e.getAttribute("data-percent")||0);anime({targets:"#progressBarFill",width:s+"%",duration:1500,easing:"easeInOutQuad"})}function nt(a){const t={gida:{name:"Gıda",icon:"🥗",total:0,color:"#22c55e"},kahvalti:{name:"Kahvaltı",icon:"🥐",total:0,color:"#f59e0b"},kahve:{name:"Kahve",icon:"☕",total:0,color:"#8b5cf6"},meyvesuyu:{name:"Meyve Suyu",icon:"🧃",total:0,color:"#ec4899"},sicak_icecek:{name:"Sıcak İçecek",icon:"🔥",total:0,color:"#ef4444"},soguk_icecek:{name:"Soğuk İçecek",icon:"🥤",total:0,color:"#3b82f6"},tatli:{name:"Tatlı",icon:"🍰",total:0,color:"#a855f7"}},e={};a.forEach(n=>{const l=`${n.date}-${n.kasa}`;(!e[l]||n.shift==="aksam")&&(e[l]=n)}),Object.values(e).forEach(n=>{t.gida.total+=parseFloat(n.gida)||0,t.kahvalti.total+=parseFloat(n.kahvalti)||0,t.kahve.total+=parseFloat(n.kahve)||0,t.meyvesuyu.total+=parseFloat(n.meyvesuyu)||0,t.sicak_icecek.total+=parseFloat(n.sicak_icecek)||0,t.soguk_icecek.total+=parseFloat(n.soguk_icecek)||0,t.tatli.total+=parseFloat(n.tatli)||0});const s=Object.values(t).reduce((n,l)=>n+l.total,0);Object.values(t).forEach(n=>{n.percentage=s>0?n.total/s*100:0});const i=Object.entries(t).map(([n,l])=>({key:n,...l})).sort((n,l)=>l.total-n.total);return{categories:i,total:s,highest:i[0],lowest:i[i.length-1],average:s/i.length}}function ot(a){return a.categories.map(t=>`
            ...
            `}async function dt(a,t,e){const s=await et(),i=U(t),n=O(t),l=Q(t),y=J(t),d=X(t,e),m=tt(t),p=nt(t),h={};t.forEach(r=>{var A;const g=r.cashier_id,G=((A=r.cashiers)==null?void 0:A.name)||"Bilinmiyor";h[g]||(h[g]={name:G,points:0,entries:0,revenue:0}),h[g].points+=parseInt(r.points_earned)||0,h[g].entries+=1,h[g].revenue+=parseFloat(r.individual_revenue)||0});const f=Object.values(h).sort((r,g)=>g.points-r.points),b=f.length>0?f[0]:null,C=t.length,B=t.filter(r=>r.is_on_time).length,z=C>0?Math.round(B/C*100):0,k=[...new Set(t.map(r=>r.date))].length,L=k>0?i.total/k:0,o=i.total,c=u==="day"&&x?x:new Date().toISOString().split("T")[0],D={};t.filter(r=>r.date===c).forEach(r=>{const g=`${r.date}-${r.kasa}`;(!D[g]||r.shift==="aksam")&&(D[g]=r)});const _=Object.values(D).reduce((r,g)=>r+parseFloat(g.total_revenue||0),0),T=s>0?Math.min(100,Math.round(_/s*100)):0,M=u==="week"?"Bu Hafta":u==="month"?`Bu Ay (${new Date().toLocaleDateString("tr-TR",{month:"long"})})`:u==="lastmonth"?`Geçen Ay (${new Date(new Date().getFullYear(),new Date().getMonth()-1,1).toLocaleDateString("tr-TR",{month:"long"})})`:u==="all"?"Tüm Veriler":u==="day"&&x?new Date(x).toLocaleDateString("tr-TR",{day:"numeric",month:"short"}):E?`${new Date(E).toLocaleDateString("tr-TR",{day:"2-digit",month:"short"})} - ${new Date(S).toLocaleDateString("tr-TR",{day:"2-digit",month:"short"})}`:"Bu Ay";document.getElementById("mainContent").innerHTML=`
            ...
            <div id="rankGrid" class="rank-grid">
                ${f.map((r,g)=>{const G=e.find(Z=>(Z.name||"")===r.name)||{},A=G.id||"",N=q(G.badge_level);return`
                    <div class="rank-card">
        ...
        `,ct(n,i,l,y);const Y=document.getElementById("applyFiltersBtn"),H=document.getElementById("clearFiltersBtn");Y&&Y.addEventListener("click",vt),H&&H.addEventListener("click",mt),document.getElementById("lastUpdate").textContent="Son güncelleme: "+new Date().toLocaleTimeString("tr-TR"),setTimeout(()=>{it(),st(),ut()},100),gt(s,_,T)}let w={};function ct(a,t,e,s){Chart.defaults.color="#7a8ba8",Chart.defaults.borderColor="#1e3a5f",Chart.defaults.font.family="DM Sans";const i=document.getElementById("dailyChart");i&&(w.daily&&w.daily.destroy(),w.daily=new Chart(i,{type:"bar",data:{labels:a.labels.length>0?a.labels:["Veri Yok"],datasets:[{label:"Günlük Ciro (₺)",data:a.data.length>0?a.data:[0],backgroundColor:"rgba(59,130,246,.7)",borderColor:"#3b82f6",borderWidth:2,borderRadius:8}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:{grid:{color:"#1e3a5f"}},y:{grid:{color:"#1e3a5f"},ticks:{callback:d=>"₺"+new Intl.NumberFormat("tr-TR").format(d)}}}}}));const n=document.getElementById("kasaChart");if(n){w.kasa&&w.kasa.destroy();const d=t.total>0,m=d?[t.restoran,t.cafetarya,t.balik,t.dondurma]:[.001,.001,.001,.001];w.kasa=new Chart(n,{type:"doughnut",data:{labels:["Restoran","Cafetarya","Balık Ekmek","Dondurma"],datasets:[{data:m,backgroundColor:["rgba(59,130,246,.8)","rgba(139,92,246,.8)","rgba(6,182,212,.8)","rgba(236,72,153,.8)"],borderColor:"#111d32",borderWidth:3,hoverOffset:8}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"bottom",labels:{padding:16,usePointStyle:!0}},tooltip:{enabled:d,callbacks:{label:p=>{const h=p.raw,f=p.dataset.data.reduce((C,B)=>C+B,0),b=Math.round(h/f*100);return` ${p.label}: ${v(h)} (%${b})`}}}},cutout:"65%"}})}const l=document.getElementById("shiftChart");l&&(w.shift&&w.shift.destroy(),w.shift=new Chart(l,{type:"bar",data:{labels:["Sabah Vardiyası","Akşam Vardiyası"],datasets:[{label:"Ciro (₺)",data:[e.sabah||0,e.aksam||0],backgroundColor:["rgba(245,158,11,.7)","rgba(139,92,246,.7)"],borderColor:["#f59e0b","#8b5cf6"],borderWidth:2,borderRadius:8}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:{grid:{color:"#1e3a5f"}},y:{grid:{color:"#1e3a5f"},ticks:{callback:d=>"₺"+new Intl.NumberFormat("tr-TR").format(d)}}}}}));const y=document.getElementById("cashierChart");if(y){w.cashier&&w.cashier.destroy();const d=Object.keys(s),m=Object.values(s);w.cashier=new Chart(y,{type:"bar",data:{labels:d.length>0?d:["Veri Yok"],datasets:[{label:"Ciro (₺)",data:m.length>0?m:[0],backgroundColor:["rgba(139,92,246,.7)","rgba(245,158,11,.7)","rgba(236,72,153,.7)","rgba(34,197,94,.7)"],borderColor:["#8b5cf6","#f59e0b","#ec4899","#22c55e"],borderWidth:2,borderRadius:8}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:{grid:{color:"#1e3a5f"}},y:{grid:{color:"#1e3a5f"},ticks:{callback:p=>"₺"+new Intl.NumberFormat("tr-TR").format(p)}}}}})}}let K=[];function P(a){return a.length===0?'<tr><td colspan="9" style="text-align:center;color:var(--txt2);padding:40px;">Henüz veri yok</td></tr>':a.map(t=>{var i;const e=parseFloat(t.total_revenue||0),s=parseFloat(t.individual_revenue||e);return`
            ...
            `}).join("")}function vt(){const a=document.getElementById("filterDate").value,t=document.getElementById("filterKasiyer").value,e=document.getElementById("filterKasa").value,s=document.getElementById("filterVardiya").value;let i=[...K];a&&(i=i.filter(n=>n.date===a)),t&&(i=i.filter(n=>n.cashier_id===t)),e&&(i=i.filter(n=>n.kasa===e)),s&&(i=i.filter(n=>n.shift===s)),document.getElementById("entriesBody").innerHTML=P(i)}function mt(){document.getElementById("filterDate").value="",document.getElementById("filterKasiyer").value="",document.getElementById("filterKasa").value="",document.getElementById("filterVardiya").value="",document.getElementById("entriesBody").innerHTML=P(K)}function v(a){return new Intl.NumberFormat("tr-TR",{minimumFractionDigits:2,maximumFractionDigits:2}).format(a||0)+" ₺"}function F(a){return v(a)}function ut(){document.querySelectorAll(".kasa-amount[data-target]").forEach(a=>{const t=parseFloat(a.dataset.target)||0,e=1200,s=performance.now();function i(n){const l=Math.min((n-s)/e,1),y=1-Math.pow(1-l,3);a.textContent=v(t*y),l<1?requestAnimationFrame(i):a.textContent=v(t)}requestAnimationFrame(i)})}function gt(a,t,e){const s=document.getElementById("floatingTarget");if(!s)return;s.style.display="block",document.getElementById("ftPct").textContent=e+"%",document.getElementById("ftTarget").textContent=v(a),document.getElementById("ftCurrent").textContent=v(t);const i=[[100,"🎉 Hedef Tamamlandı!"],[80,"💪 Hedefe Yakın!"],[50,"⏰ Yarı Yolda!"],[0,"🚀 Devam Edelim!"]];document.getElementById("ftStatus").textContent=(i.find(([l])=>e>=l)||i[3])[1];const n=document.getElementById("ftBar");n.classList.toggle("done",e>=100),n.classList.toggle("near",e>=80&&e<100),setTimeout(()=>{n.style.width=Math.min(100,e)+"%"},200)}window.showVerimlilik=async function(){document.getElementById("verimlilikModal").style.display="flex";const a=document.getElementById("verimlilikBody");a.innerHTML='<div class="loading" style="padding:40px 0;"><div class="spinner"></div><div>Veriler hesaplanıyor...</div></div>';try{const t=new Date,e=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}-01`,s=new Date(t.getFullYear(),t.getMonth()+1,0).getDate(),i=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}-${s}`,{data:n}=await $.from("daily_reports").select("date, kasa, shift, total_revenue").in("kasa",["restoran","cafetarya"]).gte("date",e).lte("date",i).order("date",{ascending:!0});if(!n||n.length===0){a.innerHTML='<div style="text-align:center;padding:40px;color:var(--txt2);">Bu ay için veri bulunamadı.</div>';return}const l={};n.forEach(o=>{l[o.date]||(l[o.date]={restoran:0,cafetarya:0}),l[o.date][o.kasa]=Math.max(l[o.date][o.kasa]||0,parseFloat(o.total_revenue)||0)});const y={};n.forEach(o=>{const c=`${o.date}-${o.kasa}`;(!y[c]||o.shift==="aksam")&&(y[c]={date:o.date,kasa:o.kasa,val:parseFloat(o.total_revenue)||0})}),Object.values(y).forEach(({date:o,kasa:c,val:D})=>{l[o]||(l[o]={restoran:0,cafetarya:0}),l[o][c]=D});const d=Object.entries(l).map(([o,c])=>({date:o,total:(c.restoran||0)+(c.cafetarya||0),restoran:c.restoran||0,cafetarya:c.cafetarya||0})).sort((o,c)=>o.date.localeCompare(c.date)),m=d.reduce((o,c)=>o+c.total,0),p=d.length,h=p>0?m/p:0,f=d.reduce((o,c)=>c.total>o.total?c:o,d[0]),b=["Pazar","Pazartesi","Salı","Çarşamba","Perşembe","Cuma","Cumartesi"],C={},B={};d.forEach(o=>{const[c,D,_]=o.date.split("-").map(Number),T=new Date(c,D-1,_).getDay();C[T]=(C[T]||0)+o.total,B[T]=(B[T]||0)+1});const z=[0,1,2,3,4,5,6].filter(o=>B[o]).map(o=>({name:b[o],avg:C[o]/B[o],idx:o})).sort((o,c)=>c.avg-o.avg),k=z.length>0?z[0].avg:1,L=t.toLocaleDateString("tr-TR",{month:"long",year:"numeric"});a.innerHTML=`
                    <div class="ver-stats-grid">
                        ...
                        <div class="ver-stat-card" style="border-color:var(--orange);">
                            ...
                            <div class="ver-stat-sub">${f?(()=>{const[o,c,D]=f.date.split("-").map(Number);return new Date(o,c-1,D).toLocaleDateString("tr-TR",{day:"numeric",month:"long",weekday:"short"})})():"-"}</div>
                        </div>
                    </div>
                    ...
                    <div style="max-height:320px;overflow-y:auto;border-radius:10px;border:1px solid var(--brd);">
                        <table class="ver-daily-table">
                            ...
                            <tbody>
                                ${d.map(o=>{const c=o.date===(f==null?void 0:f.date),[D,_,T]=o.date.split("-").map(Number),M=new Date(D,_-1,T).toLocaleDateString("tr-TR",{weekday:"short"});return`<tr${c?' class="top-row"':""}>
                                        <td>${String(T).padStart(2,"0")+"/"+String(_).padStart(2,"0")}</td>
            ...
            `,document.body.appendChild(t)};window.confirmDelete=async function(a){const t=document.querySelector(".modal-overlay");try{console.log("Siliniyor:",a);const{data:e,error:s}=await $.from("daily_reports").delete().eq("id",a);if(console.log("Delete response:",{data:e,error:s}),s)throw new Error(s.message);t&&t.remove(),I("✅ Kayıt başarıyla silindi!","success"),await loadDashboard()}catch(e){console.error("Silme hatası:",e),I("❌ Silme başarısız: "+e.message,"error"),t&&t.remove()}};window.editEntry=async function(a){console.log("editEntry çağrıldı:",a);const{data:t,error:e}=await $.from("daily_reports").select("*").eq("id",a).single();if(e){I("❌ Kayıt bulunamadı","error");return}const s=document.createElement("div");s.className="modal-overlay",s.innerHTML=`
            ...
            `,document.body.appendChild(s)};window.confirmEdit=async function(a){const t=document.querySelector(".modal-overlay");try{const e=parseFloat(document.getElementById("editZCiro").value)||0,s=parseInt(document.getElementById("editPuan").value)||0,i=document.getElementById("editDurum").value==="true";console.log("Güncelleniyor:",{entryId:a,newZCiro:e,newPuan:s,newDurum:i});const{error:n}=await $.from("daily_reports").update({total_revenue:e,points_earned:s,is_on_time:i}).eq("id",a);if(n)throw n;const{data:l}=await $.from("daily_reports").select("cashier_id").eq("id",a).single();if(!l)throw new Error("Kayıt bulunamadı");const{data:y}=await $.from("daily_reports").select("points_earned").eq("cashier_id",l.cashier_id),d=y.reduce((h,f)=>h+(parseInt(f.points_earned)||0),0);console.log("Toplam puan:",d);let m="yeni";d>=1e3?m="efsane":d>=500?m="elmas":d>=300?m="altin":d>=150?m="gumus":d>=50&&(m="bronz");const{error:p}=await $.from("cashiers").update({total_points:d,badge_level:m}).eq("id",l.cashier_id);if(p)throw p;t&&t.remove(),I("✅ Kayıt ve kasiyer puanı güncellendi!","success"),await loadDashboard()}catch(e){console.error("Güncelleme hatası:",e),I("❌ Güncelleme başarısız: "+e.message,"error"),t&&t.remove()}};function I(a,t="success"){const e=document.createElement("div");e.style.cssText=`
                position:fixed;
                bottom:20px;
                right:20px;
